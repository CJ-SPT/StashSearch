...
public static class ItemClasses
{
    ...
    public static readonly Dictionary<ItemClassId, Func<Item, bool>> ItemClassConditionMap = new Dictionary<ItemClassId, Func<Item, bool>>
    {
        ...
        {ItemClassId.Barter, item => item is GClass2719},
        {ItemClassId.Rigs, item => item is GClass2700},
        {ItemClassId.Goggles, item => item is GogglesClass},
        {ItemClassId.Containers, item => item is SearchableItemClass || item is GClass2701},
        {ItemClassId.Armor, item => item is GClass2652},
        {ItemClassId.Info, item => item is GClass2754},
        {ItemClassId.Keys, item => item is GClass2735},
        {ItemClassId.Special, item => item is GClass2746},
